...
public class SearchPriceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<tblGlasses> listGlasses;
            if (user == null) {
                listGlasses = glassesDao.searchByPriceRangeUS(minPrice, maxPrice);
            } else if (user.getRoleID().equals("AD")) {
                listGlasses = glassesDao.searchByPriceRange(minPrice, maxPrice);
            } else {
                listGlasses = glassesDao.searchByPriceRangeUS(minPrice, maxPrice);
            }
